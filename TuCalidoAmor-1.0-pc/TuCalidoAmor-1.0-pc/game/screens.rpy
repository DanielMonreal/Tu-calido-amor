...
screen main_menu():
    imagemap:
        ...
        hotspot (44, 31, 430, 426) clicked Start()
        hotspot (649, 33, 606, 157) clicked ShowMenu("load")
        hotspot (1383, 28, 479, 153) clicked ShowMenu("preferences")
        hotspot (1486, 848, 272, 170) action Quit(confirm=False)
